const MemRooms = {
    run: function () {
            ...
            for (let gameRoomKey in Game.rooms) {
                ...
                if (gameRoom.controller) { // has a controller - is ownable
                    ...
                    for (let memRoomKey in Memory.MemRooms) {
                        ...
                        if(gameRoomKey === memRoomKey){ // I have it in memory!
                            ...
                            if(gameRoom.controller.my){ // still my room
                                ...
                                console.log("MemRooms, UpdateMemRooms: do not own " + gameRoom.name + " anymore. removing room from mem");
                    ...
                    if(gameRoom.controller.my){
                        UpdateJobsInRoom(gameRoom, oldMemRoom.RoomObjJobs, fullUpdate);
                    }
                }
            }
        }

        function UpdateJobsInRoom(gameRoom, oldRoomObjJobs, fullUpdate){
            let roomObjJobs = [];
        ...
        function RefreshJobsInRoom(gameRoom){
