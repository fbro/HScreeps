    ...
    FindNumberOfBuildableStructures: function (gameRoom, structureType) {
        switch (true) {
            ...
            case structureType === STRUCTURE_SPAWN:
                ...
                break;
            case structureType === STRUCTURE_STORAGE:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
            ...
            case structureType === STRUCTURE_LINK:
                ...
                break;
            case structureType === STRUCTURE_FACTORY:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
                ...
                break;
            case structureType === STRUCTURE_OBSERVER:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
                ...
                break;
            case structureType === STRUCTURE_POWER_SPAWN:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
                ...
                break;
            case structureType === STRUCTURE_TERMINAL:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
                ...
                break;
            case structureType === STRUCTURE_EXTRACTOR:
                switch (gameRoom.controller.level) {
                    case 1:
                    case 2:
                    case 3:
